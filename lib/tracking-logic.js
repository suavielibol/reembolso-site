...
export async function initializeTracking() {
  ...
  if (window.fbq) {
    console.log("TrackingLogic: Initializing FB Pixel with ID 1089564736393941 and userData:", userData)
    window.fbq("init", "1089564736393941", userData) // Use your Pixel ID
  } else {
