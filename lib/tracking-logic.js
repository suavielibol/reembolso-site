...
export async function initializeTracking() {
  ...
  if (window.fbq) {
    console.log("TrackingLogic: Initializing FB Pixel with ID 656489137413556 and userData:", userData)
    window.fbq("init", "656489137413556", userData) // Use your Pixel ID
  } else {
